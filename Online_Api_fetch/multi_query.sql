...
LEFT OUTER JOIN jse_cf_mother_tongue ON jse_cf_mother_tongue.mother_tongue_id = bak_pis_personnel.Mother_Tongue_Languages
...
LEFT OUTER JOIN jse_cf_source_of_recruitment ON jse_cf_source_of_recruitment.recruitment_id = bak_pis_personnel.Recruitment_Mode, bak_pis_qualification
...
LEFT OUTER JOIN jse_cf_department Q1 ON Q1.MinDeptCode = bak_pis_posting.DepartmentCode
LEFT OUTER JOIN jse_cf_department Q2 ON Q2.MinDeptCode = bak_pis_posting.MinisteryCode
LEFT OUTER JOIN jse_cf_department Q3 ON Q3.MinDeptCode = bak_pis_posting.OfficerCode,bak_pis_fieldofexperience
...
WHERE 1 = 1 AND bak_pis_personnel.OfficerId = bak_pis_qualification.OfficerId AND bak_pis_personnel.OfficerId = bak_pis_posting.OfficerId AND bak_pis_personnel.OfficerId = bak_pis_fieldofexperience.OfficerId AND bak_pis_personnel.OfficerId = bak_pis_central_deputation_info.OfficerID AND bak_pis_personnel.OfficerId = bak_pis_debarmentinfo.OfficerID
