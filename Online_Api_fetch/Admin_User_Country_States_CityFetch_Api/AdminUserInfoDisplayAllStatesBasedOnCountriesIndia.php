...
$AdminUserCountryStatesCityResult = AdminUserInfoDisplayAllStatesBasedOnCountriesIndia();

while($AdminUserCountryStatesCityrow = mysqli_fetch_array($AdminUserCountryStatesCityResult))
{
	$AdminUserStatesList = array();
	$AdminUserStatesList['IndiaStates'] = $AdminUserCountryStatesCityrow["IndiaStates"];
