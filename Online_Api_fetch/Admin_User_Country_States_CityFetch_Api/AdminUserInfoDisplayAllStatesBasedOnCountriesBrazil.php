...
$AdminUserCountryStatesCityResult = AdminUserInfoDisplayAllStatesBasedOnCountriesBrazil();

while($AdminUserCountryStatesCityrow = mysqli_fetch_array($AdminUserCountryStatesCityResult))
{
	$AdminUserStatesList = array();
	$AdminUserStatesList['BrazilStates'] = $AdminUserCountryStatesCityrow["BrazilStates"];
