...
$AdminUserCountryStatesCityResult = AdminUserInfoDisplayAllStatesBasedOnCountriesUnitedStates();

while($AdminUserCountryStatesCityrow = mysqli_fetch_array($AdminUserCountryStatesCityResult))
{
	$AdminUserStatesList = array();
	$AdminUserStatesList['UnitedStatesStates'] = $AdminUserCountryStatesCityrow["UnitedStatesStates"];
