...
$AdminUserCountryStatesCityResult = AdminUserInfoDisplayAllStatesBasedOnCountriesAfghanistan();

while($AdminUserCountryStatesCityrow = mysqli_fetch_array($AdminUserCountryStatesCityResult))
{
	$AdminUserStatesList = array();
	$AdminUserStatesList['AfghanistanStates'] = $AdminUserCountryStatesCityrow["AfghanistanStates"];
