...
$AdminUserCountryStatesCityResult = AdminUserInfoDisplayAllStatesBasedOnCountriesJapan();

while($AdminUserCountryStatesCityrow = mysqli_fetch_array($AdminUserCountryStatesCityResult))
{
	$AdminUserStatesList = array();
	$AdminUserStatesList['JapanStates'] = $AdminUserCountryStatesCityrow["JapanStates"];
