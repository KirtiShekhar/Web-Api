...
$maindirectoryJointSecretaryEquivalentlistresult = maindirectorylistfetch_display_JointSecretaryEquivalent_list();

while($maindirectorylistrows = mysqli_fetch_array($maindirectoryJointSecretaryEquivalentlistresult))
{
