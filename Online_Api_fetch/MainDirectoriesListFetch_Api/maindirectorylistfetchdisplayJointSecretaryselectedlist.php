...
$maindirectoryJointSecretarylistresult = maindirectorylistfetch_display_JointSecretary_list();

while($maindirectorylistrows = mysqli_fetch_array($maindirectoryJointSecretarylistresult))
{
