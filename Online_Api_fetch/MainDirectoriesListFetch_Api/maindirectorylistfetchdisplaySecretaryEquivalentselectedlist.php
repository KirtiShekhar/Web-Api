...
$maindirectorySecretaryEquivalentlistresult = maindirectorylistfetch_display_SecretaryEquivalent_list();

while($maindirectorylistrows = mysqli_fetch_array($maindirectorySecretaryEquivalentlistresult))
{
