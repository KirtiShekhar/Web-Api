...
$maindirectorySecretarylistresult = maindirectorylistfetch_display_Secretary_list();

while($maindirectorylistrows = mysqli_fetch_array($maindirectorySecretarylistresult))
{
