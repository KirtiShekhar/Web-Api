...
$maindirectoryAdditionalSecretaryEquivalentlistresult = maindirectorylistfetch_display_AdditionalSecretaryEquivalent_list();

while($maindirectorylistrows = mysqli_fetch_array($maindirectoryAdditionalSecretaryEquivalentlistresult))
{
