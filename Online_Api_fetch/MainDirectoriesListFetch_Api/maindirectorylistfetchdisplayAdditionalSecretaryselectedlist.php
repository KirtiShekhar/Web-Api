...
$maindirectoryAdditionalSecretarylistresult = maindirectorylistfetch_display_AdditionalSecretary_list();

while($maindirectorylistrows = mysqli_fetch_array($maindirectoryAdditionalSecretarylistresult))
{
