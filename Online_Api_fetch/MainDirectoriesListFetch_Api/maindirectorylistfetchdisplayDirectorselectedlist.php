...
$maindirectoryDirectorlistresult = maindirectorylistfetch_display_Director_list();

while($maindirectorylistrows = mysqli_fetch_array($maindirectoryDirectorlistresult))
{
