...
$maindirectoryUnderSecretaryEquivalentlistresult = maindirectorylistfetch_display_UnderSecretaryEquivalent_list();

while($maindirectorylistrows = mysqli_fetch_array($maindirectoryUnderSecretaryEquivalentlistresult))
{
