...
$maindirectoryDeputySecretarylistresult = maindirectorylistfetch_display_DeputySecretary_list();

while($maindirectorylistrows = mysqli_fetch_array($maindirectoryDeputySecretarylistresult))
{
